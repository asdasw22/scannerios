...
enum SampleDataSeeder {
  ...
  private static func upgradeBundledTemplateIfNeeded(in context: ModelContext) {
    ...
    for storedTemplate in templates {
      ...
      guard isBundled, definition.revision < 5 else { continue }
  ...
  static func template(questionCount: Int = 20, choicesPerQuestion: Int = 5) -> TemplateDefinition {
    ...
    calibration.minimumSelectionMargin = 0.13
    calibration.minimumMarkerCount = 6
    calibration.markerReprojectionTolerance = 0.024
    ...
    return TemplateDefinition(
      ...
      revision: 5,
      profileName: "ReferenceSheet-591x520",
      strictRegistration: true,
      maximumAlignmentDrift: 0.072
    )
  }
